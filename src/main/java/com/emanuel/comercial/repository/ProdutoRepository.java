...
public interface ProdutoRepository extends JpaRepository<Produto, Long> {
	...
	// Não levar em consideração a letras maiúsculas ou minúsculas
	...
	// Todos os produtos com os IDs passados no varargs. Poderia usar NotIn para
	// negar os IDs.
	...
	// Buscar todos os produtos que estão com a propriedade ativa como FALSE
	List<Produto> findByAtivoFalse();

	// Buscar onde a data de cadastro é depois do parâmetro passado. Pode ser usado Before também.
